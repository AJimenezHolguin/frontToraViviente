...
import { Playlist, PlaylistType } from "@/types/PlaylistsTypesProps";
      ...
      switch (columnKey) {
        ...
        case "fileSong":
          const hasFileSong =
            ...
            data.songs.some((song) => song.fileSong?.secure_url);

          return hasFileSong ? (
            <Link
              className="flex justify-center items-center"
              href={`/dashboard/${type}/${data._id}/songs`}
            >
        ...
        case "fileScore":
          const hasFileScore =
            Array.isArray(data.songs) &&
            data.songs.some((song) => song.fileScore?.secure_url);

          return hasFileScore ? (
            <Link
              className="flex justify-center items-center"
              href={`/dashboard/${type}/${data._id}/scores`}
            >
