    ...
    <>
      ...
      <div className="py-0.5 px-1 flex justify-between items-center">
        <div className="flex items-center">
          ...
          >
            <Text $color={COLORS.primary}>Atrás</Text>
          </button>
          ...
          >
            <Text $color={COLORS.primary}>Siguiente</Text>
          </button>
        </div>
      ...
      {isMobileOrTablet && !error && (
        <div className="flex items-center gap-3 p-2 bg-gray-100">
